...
public class CeActivityDto {
  ...
  /**
   * A flag indicating whether the current activity has an error stacktrace of not.
   * <p>
   * This property <strong>is ignored when inserting</strong> and populated when reading.
   * </p>
   */
  ...
  CeActivityDto setHasErrorStacktrace(boolean hasErrorStacktrace) {
  ...
  public String toString() {
    return MoreObjects.toStringHelper(this)
      ...
      .add("hasErrorStacktrace", hasErrorStacktrace)
      .toString();
  }
}
