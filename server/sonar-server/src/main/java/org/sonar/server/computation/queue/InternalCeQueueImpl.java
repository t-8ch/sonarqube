...
public class InternalCeQueueImpl extends CeQueueImpl implements InternalCeQueue {
  ...
  private void updateError(CeActivityDto activityDto, @Nullable Throwable error) {
    if (error == null) {
      return;
    }
  ...
  private static String getStackTraceForPersistence(Throwable error) {
    ...
    try (ByteArrayOutputStream out = new ByteArrayOutputStream();
      LineReturnControllerPrintStream printStream = new LineReturnControllerPrintStream(out);) {
   ...
   */
  private static class LineReturnControllerPrintStream extends PrintWriter {

    LineReturnControllerPrintStream(OutputStream out) {
      super(out);
    }
